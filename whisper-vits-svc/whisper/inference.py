...
def load_model(model_path, device) -> Whisper:
...
def pred_ppg(model: Whisper, wavPath, ppgPath, device):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wav", "-w", help="wav", dest="wav", required=True)
    parser.add_argument("-ppg", "-p", help="ppg", dest="ppg", required=True)
