...
totallens = len(names)
# If the space is large enough, you could utilize the total lengths
stoplens = int(0.3 * totallens)
fea_batch = []
# Merge the features
count = 0
for name in names:
...
kaldiio.save_ark('libri_token_faiss.ark', faiss_k_means,
                 'libri_token_faiss.scp', False)
