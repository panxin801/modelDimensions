...
class RegressionHead(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.out_proj = nn.Linear(
            config.hidden_size, config.num_labels)  # config.num_labels=3
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Emotion Extraction Preprocess')
    parser.add_argument('--filelists', dest='filelists',
                        nargs="+", type=str, help='path of the filelists')
